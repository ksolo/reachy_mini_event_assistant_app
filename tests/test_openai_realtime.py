...
import reachy_mini_event_assistant_app.openai_realtime as rt_mod
from reachy_mini_event_assistant_app.openai_realtime import OpenaiRealtimeHandler, _compute_response_cost
