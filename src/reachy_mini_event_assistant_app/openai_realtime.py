...
from reachy_mini_event_assistant_app.prompts import get_session_voice, get_session_instructions
from reachy_mini_event_assistant_app.tools.core_tools import (
    ToolDependencies,
    get_tool_specs,
    dispatch_tool_call,
)
...
class OpenaiRealtimeHandler(AsyncStreamHandler):
    ...
    async def apply_personality(self, profile: str | None) -> str:
        ...
        try:
            ...
            from reachy_mini_event_assistant_app.config import config as _config
            from reachy_mini_event_assistant_app.config import set_custom_profile
