...
from reachy_mini_event_assistant_app.utils import (
    parse_args,
    setup_logger,
    handle_vision_stuff,
...
def run(
    ...
    from reachy_mini_event_assistant_app.moves import MovementManager
    from reachy_mini_event_assistant_app.console import LocalStream
    from reachy_mini_event_assistant_app.openai_realtime import OpenaiRealtimeHandler
    from reachy_mini_event_assistant_app.tools.core_tools import ToolDependencies
    from reachy_mini_event_assistant_app.audio.head_wobbler import HeadWobbler
    ...
    if args.gradio:
        ...
        from reachy_mini_event_assistant_app.gradio_personality import PersonalityUI
...
class ReachyMiniEventAssistantApp(ReachyMiniApp):  # type: ignore[misc]
...
if __name__ == "__main__":
    app = ReachyMiniEventAssistantApp()
    try:
        app.wrapped_run()
    except KeyboardInterrupt:
        app.stop()
