...
from reachy_mini_event_assistant_app.config import DEFAULT_PROFILES_DIRECTORY as DEFAULT_PROFILES_PATH  # noqa: F401
...
DEFAULT_PROFILES_MODULE = "reachy_mini_event_assistant_app.profiles"
...
def _load_profile_tools() -> None:
    ...
    for tool_name in tool_names:
        ...
        if not loaded:
            shared_module_path = f"reachy_mini_event_assistant_app.tools.{tool_name}"
            try:
                source = _try_load_tool(
                    tool_name,
